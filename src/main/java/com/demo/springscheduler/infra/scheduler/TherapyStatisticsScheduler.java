...
//
//        log.info("[Therapy Statistics Batch] 통계 집계 시작");
//
//        for(Long therapyUserId : targetTherapyUserIds) {
//            therapyBatchLogUseCase.markProgress(therapyUserId, yearMonth.getYear(), yearMonth.getMonthValue(), startDateTime, endDateTime);
